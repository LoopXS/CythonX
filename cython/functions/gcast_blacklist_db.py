...
def add_gblacklist(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"CɪᴘʜᴇʀX ᴇxᴄlusivᴇ ʙᴏᴛ LOG : // functions/gcast_blacklist_db/add_gblacklist : {e}")
        return False
...
def rem_gblacklist(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"CɪᴘʜᴇʀX ᴇxᴄlusivᴇ ʙᴏᴛ LOG : // functions/gcast_blacklist_db/rem_gblacklist : {e}")
        return False
